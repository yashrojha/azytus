                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="section-title two">
                            <?php if (!empty($settings['matrik_benefit_genaral_subtitle'])) : ?>
                                <span><?php echo wp_kses_post($settings['matrik_benefit_genaral_subtitle']); ?></span>
                            <?php endif; ?>
                            <?php if (!empty($settings['matrik_benefit_genaral_title'])) : ?>
                                <h2><?php echo wp_kses_post($settings['matrik_benefit_genaral_title']); ?></h2>
                            ...
                            <?php foreach ($settings['matrik_benefit_genaral_content_list'] as $data) : ?>
                                <li class="single-benefit wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    <?php if (!empty($data['matrik_benefit_genaral_content_step_count'])) : ?>
                                        <div class="number">
                                            <span><?php echo wp_kses_post($data['matrik_benefit_genaral_content_step_count']); ?></span>
                                        </div>
                                    <?php endif; ?>
                                    <div class="content">
                                        <?php if (!empty($data['matrik_benefit_genaral_content_title'])) : ?>
                                            <h4><?php echo wp_kses_post($data['matrik_benefit_genaral_content_title']); ?></h4>
                                        <?php endif; ?>
                                        <?php if (!empty($data['matrik_benefit_genaral_content_description'])) : ?>
                                            <p><?php echo wp_kses_post($data['matrik_benefit_genaral_content_description']); ?></p>
                                        <?php endif; ?>
                                    </div>
                                </li>
                            <?php endforeach; ?>
