                        ...
                        <div class="col-lg-8">
                            <div class="service-details-content">
                                <?php if (!empty($settings['matrik_service_details_genaral_title'])) : ?>
                                    <h2><?php echo wp_kses_post($settings['matrik_service_details_genaral_title']); ?></h2>
                                <?php endif; ?>
                                <?php if (!empty($settings['matrik_service_details_genaral_description_one'])) : ?>
                                    <p><?php echo wp_kses_post($settings['matrik_service_details_genaral_description_one']); ?></p>
                                <?php endif; ?>
                                <?php if (!empty($settings['matrik_service_details_genaral_description_two'])) : ?>
                                    <p><?php echo wp_kses_post($settings['matrik_service_details_genaral_description_two']); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="service-details-content">
                        <div class="title-area">
                            <?php if (!empty($settings['matrik_service_details_genaral_style_two_title'])) : ?>
                                <h2><?php echo wp_kses_post($settings['matrik_service_details_genaral_style_two_title']); ?></h2>
                            <?php endif; ?>
                            <?php if (!empty($settings['matrik_service_details_genaral_style_two_description'])) : ?>
                                <p><?php echo wp_kses_post($settings['matrik_service_details_genaral_style_two_description']); ?></p>
                            <?php endif; ?>
                        </div>
                        <ul>
                            <?php foreach ($settings['matrik_service_details_style_two_content_list'] as $data) : ?>
                                <?php if (!empty($data['matrik_service_details_style_two_list_title'])) : ?>
                                    <li>
                                        ...
                                        <?php echo wp_kses_post($data['matrik_service_details_style_two_list_title']); ?>
                                    </li>
                                <?php endif; ?>
                            <?php endforeach; ?>
                        </ul>
                                        ...
                                        <?php if (!empty($data['matrik_service_details_genaral_style_three_faq_question'])) : ?>
                                            <h2 class="accordion-header" id="<?php echo esc_attr($heading_id); ?>">
                                                <button
                                                    ...
                                                    <?php echo wp_kses_post($data['matrik_service_details_genaral_style_three_faq_question']); ?>
                                                </button>
                                            </h2>
                                        <?php endif; ?>
                                        ...
                                        <?php if (!empty($data['matrik_service_details_genaral_style_three_faq_answer'])) : ?>
                                            <div
                                                ...
                                                <div class="accordion-body">
                                                    <?php echo wp_kses_post($data['matrik_service_details_genaral_style_three_faq_answer']); ?>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </div>
