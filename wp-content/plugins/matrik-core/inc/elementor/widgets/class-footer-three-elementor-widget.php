...
class Matrik_Footer_Three_Widget extends Widget_Base
{

    public function get_name()
    {
        return 'matrik_footer_three';
    }

    public function get_title()
    {
        return esc_html__('EG Footer Three', 'matrik-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'matrik_footer_three_genaral_logo_image',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_logo_image_url',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_description',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_title_text',
            [
        ...
        $this->start_controls_section(
            'matrik_footer_three_genaral_address_area',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_address_area_title',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_address_area_address_text',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_address_area_address_text_url',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_address_area_list',
            [
                ...
                'default' => [
                    [
                        'matrik_footer_three_genaral_address_area_title' => esc_html('NEW YORK'),

                    ],
                    [
                        'matrik_footer_three_genaral_address_area_title' => esc_html('WASHINGTON DC'),

                    ],

                ],
                'title_field' => '{{{ matrik_footer_three_genaral_address_area_title }}}',
            ]
        );

        $this->add_control(
            'matrik_footer_three_genaral_address_area_button_text',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_address_area_button_text_url',
            [
        ...
        $this->start_controls_section(
            'matrik_footer_three_genaral_menu_one_area',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_menu_one_area_menu_title',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_menu_one_area_menu_content_title',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_menu_one_area_menu_content_title_url',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_menu_one_area_menu_content_list',
            [
                ...
                'default' => [
                    [
                        'matrik_footer_three_genaral_menu_one_area_menu_content_title' => esc_html('About Us'),

                    ],
                    [
                        'matrik_footer_three_genaral_menu_one_area_menu_content_title' => esc_html('Meet Our Team'),

                    ],
                    [
                        'matrik_footer_three_genaral_menu_one_area_menu_content_title' => esc_html('Our Project'),

                    ],
                    [
                        'matrik_footer_three_genaral_menu_one_area_menu_content_title' => esc_html('Blog & Article'),

                    ],
                    [
                        'matrik_footer_three_genaral_menu_one_area_menu_content_title' => esc_html('Solutions'),

                    ],

                ],
                'title_field' => '{{{ matrik_footer_three_genaral_menu_one_area_menu_content_title }}}',
            ]
        );
        ...
        $this->start_controls_section(
            'matrik_footer_three_genaral_menu_two_area',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_menu_two_area_menu_title',
            [
                'label'       => esc_html__('Menu Title', 'matrik-core'),
                'type'        => \Elementor\Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_menu_two_area_menu_content_title',
            [
                'label'       => esc_html__('Content Title', 'matrik-core'),
                'type'        => \Elementor\Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_menu_two_area_menu_content_title_url',
            [
                'label'   => esc_html__('URL/Link', 'matrik-core'),
                'type'    => \Elementor\Controls_Manager::URL,
                'options' => ['url', 'is_external', 'nofollow'],
        ...
        $this->add_control(
            'matrik_footer_three_genaral_menu_two_area_menu_content_list',
            [
                'label' => esc_html__('Content List', 'matrik-core'),
                'type' => \Elementor\Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'matrik_footer_three_genaral_menu_two_area_menu_content_title' => esc_html('Open Positions'),

                    ],
                    [
                        'matrik_footer_three_genaral_menu_two_area_menu_content_title' => esc_html('Students'),

                    ],
                    [
                        'matrik_footer_three_genaral_menu_two_area_menu_content_title' => esc_html('Diversity & Inclusion'),

                    ],
                    [
                        'matrik_footer_three_genaral_menu_two_area_menu_content_title' => esc_html('Factory Employ'),

                    ],
                ],
                'title_field' => '{{{ matrik_footer_three_genaral_menu_two_area_menu_content_title }}}',
            ]
        );
        ...
        $this->start_controls_section(
            'matrik_footer_three_genaral_contact',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_contact_icon',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_contact_title',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_contact_type',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_contact_phone_number',
            [
                ...
                'label_block' => true,
                'condition' => [
                    'matrik_footer_three_genaral_contact_type' => 'phone',
                ]
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_contact_email',
            [
                ...
                'label_block' => true,
                'condition' => [
                    'matrik_footer_three_genaral_contact_type' => 'email',
                ]
            ]
        );

        $repeater->add_control(
            'matrik_footer_three_genaral_contact_custom',
            [
                ...
                'label_block' => true,
                'condition' => [
                    'matrik_footer_three_genaral_contact_type' => 'custom',
                ]
            ]
        );

        $repeater->add_control(
            'matrik_footer_three_genaral_contact_custom_url',
            [
                'label'   => esc_html__('URL/Link', 'matrik-core'),
                'type'    => \Elementor\Controls_Manager::URL,
                'options' => ['url', 'is_external', 'nofollow'],
        ...
        $this->add_control(
            'matrik_footer_three_genaral_contact_list',
            [
                ...
                'default' => [
                    [
                        'matrik_footer_three_genaral_contact_title' => esc_html('CALL ANY TIME'),
                        'matrik_footer_three_genaral_contact_type' => esc_html('phone'),


                    ],
                    [
                        'matrik_footer_three_genaral_contact_title' => esc_html('ADDRESS'),
                        'matrik_footer_three_genaral_contact_type' => esc_html('custom'),

                    ],
                    [
                        'matrik_footer_three_genaral_contact_title' => esc_html('SAY HELLO'),
                        'matrik_footer_three_genaral_contact_type' => esc_html('email'),

                    ],
                ],
                'title_field' => '{{{ matrik_footer_three_genaral_contact_title }}}',
            ]
        );
        ...
        $this->start_controls_section(
            'matrik_footer_three_genaral_copyright_and_social',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_copyright_and_social_text',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_copyright_and_social_social_icon',
            [
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_copyright_and_social_social_title',
            [
                'label'       => esc_html__('Title', 'matrik-core'),
                'type'        => \Elementor\Controls_Manager::TEXT,
        ...
        $repeater->add_control(
            'matrik_footer_three_genaral_copyright_and_social_social_icon_url',
            [
        ...
        $this->add_control(
            'matrik_footer_three_genaral_copyright_and_social_social_icon_list',
            [
                ...
                'default' => [
                    [
                        ...
                        'matrik_footer_three_genaral_copyright_and_social_social_title' => esc_html('Linkedin'),
                    ...
                    [
                        ...
                        'matrik_footer_three_genaral_copyright_and_social_social_title' => esc_html('Facebook'),
                    ...
                    [
                        ...
                        'matrik_footer_three_genaral_copyright_and_social_social_title' => esc_html('Twitter'),
                    ...
                    [
                        ...
                        'matrik_footer_three_genaral_copyright_and_social_social_title' => esc_html('Instagram'),
        ...
        $this->start_controls_section(
            'matrik_footer_three_style_genaral',
            [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_description',
            [
                'label'     => esc_html__('Description', 'matrik-core'),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'name'     => 'matrik_footer_three_style_genaral_description_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_description_color',
            [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_established_title',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_established_title_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_established_title_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_location_title',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_location_title_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_location_title_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_location',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_location_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_location_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_location_hover_color',
            [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_location_icon_color',
            [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_location_button',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_location_button_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_location_button_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_menu_title',
            [
                'label'     => esc_html__('Menu Title', 'matrik-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_menu_title_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_menu_title_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_menu',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_menu_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_menu_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_menu_hover_color',
            [
                'label'     => esc_html__('Hover Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_menu_icon_color',
            [
                'label'     => esc_html__('Icon Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_contact_icon',
            [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_contact_icon_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_contact_title',
            [
                'label'     => esc_html__('Contact Title', 'matrik-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_contact_title_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_contact_title_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_contact',
            [
                'label'     => esc_html__('Contact', 'matrik-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_contact_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_contact_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_contact_hover_color',
            [
                'label'     => esc_html__('Hover Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_copyright_text',
            [
                'label'     => esc_html__('Copyright Text', 'matrik-core'),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'after',
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_copyright_text_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_copyright_text_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_copyright_text_span_color',
            [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_copyright_text_span_hover_color',
            [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_copyright_social_icon',
            [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'matrik-core'),
                'name'     => 'matrik_footer_three_style_genaral_copyright_social_icon_typ',
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_copyright_social_icon_color',
            [
                'label'     => esc_html__('Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'matrik_footer_three_style_genaral_copyright_social_icon_hover_color',
            [
                'label'     => esc_html__('Hover Color', 'matrik-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                ...
                <div class="container">
                    <div class="footer-top-area">
                        <div class="row g-4 align-items-center">
                            <?php if (!empty($settings['matrik_footer_three_genaral_logo_image']['url'])) : ?>
                                <div class="col-md-3">
                                    <a href="<?php echo esc_url($settings['matrik_footer_three_genaral_logo_image_url']['url']); ?>" class="footer-logo">
                                        <img src="<?php echo esc_url($settings['matrik_footer_three_genaral_logo_image']['url']); ?>" alt="<?php echo esc_attr__('logo-image', 'matrik-core'); ?>">
                                    </a>
                                </div>
                            <?php endif; ?>
                                    ...
                                    <div class="row gy-5">
                                            ...
                                            <div class="footer-widget">
                                                ...
                                                <div class="menu-container">
                                                    <ul class="widget-list">
                                                        <?php foreach ($settings['matrik_footer_three_genaral_menu_one_area_menu_content_list'] as $data) : ?>
                                        ...
                                        <div class="col-md-4 col-sm-6 d-flex justify-content-lg-center">
                                            <div class="footer-widget">
                                                ...
                                                <div class="menu-container">
                                                    <ul class="widget-list">
                                                        <?php foreach ($settings['matrik_footer_three_genaral_menu_two_area_menu_content_list'] as $data) : ?>
                                        ...
                                        <div class="col-md-4 col-sm-6 d-flex justify-content-lg-end">
                                            <ul class="contact-area">
                                                <?php
                                                $total_items = count($settings['matrik_footer_three_genaral_contact_list']);
                                                $index = 0;
                                                foreach ($settings['matrik_footer_three_genaral_contact_list'] as $data) :
                                                    $index++; ?>
                                                    <li>
                                                        <div class="single-contact">
                                                            <div class="icon">
                                                                <?php
                                                                $icon_url = $data['matrik_footer_three_genaral_contact_icon']['url'];
                                                                $icon_path = get_attached_file($data['matrik_footer_three_genaral_contact_icon']['id']);
            ...
            <div class="footer-bottom-wrap">
                <div class="container">
                    <div class="footer-bottom">
                        <?php if (!empty($settings['matrik_footer_three_genaral_copyright_and_social_text'])) : ?>
                            <div class="copyright-area">
                                <p><?php echo wp_kses($settings['matrik_footer_three_genaral_copyright_and_social_text'], wp_kses_allowed_html('post'))  ?></p>
                            </div>
                        <?php endif; ?>
                        <ul class="social-area">
                            <?php foreach ($settings['matrik_footer_three_genaral_copyright_and_social_social_icon_list'] as $data) :
                                $icon = $data['matrik_footer_three_genaral_copyright_and_social_social_icon'];
                            ?>
                                <li>
                                    <a href="<?php echo esc_url($data['matrik_footer_three_genaral_copyright_and_social_social_icon_url']['url']); ?>">
...
Plugin::instance()->widgets_manager->register(new Matrik_Footer_Three_Widget());
