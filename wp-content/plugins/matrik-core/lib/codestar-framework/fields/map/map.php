  ...
  class CSF_Field_map extends CSF_Fields {
    ...
    public function render() {
      ...
      $args              = wp_parse_args( $this->field, array(
        'placeholder'    => esc_html__( 'Search...', 'matrik-core' ),
        'latitude_text'  => esc_html__( 'Latitude', 'matrik-core' ),
        'longitude_text' => esc_html__( 'Longitude', 'matrik-core' ),
        'address_field'  => '',
        'height'         => '',
      ) );
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-leaflet' ) ) {
        wp_enqueue_script( 'csf-leaflet', esc_url( $this->cdn_url . $this->version .'/dist/leaflet.js' ), array( 'matrik-core' ), $this->version, true );
      }
