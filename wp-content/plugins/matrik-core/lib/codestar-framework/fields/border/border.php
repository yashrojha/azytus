  ...
  class CSF_Field_border extends CSF_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        ...
        'top_placeholder'    => esc_html__( 'top', 'matrik-core' ),
        'right_placeholder'  => esc_html__( 'right', 'matrik-core' ),
        'bottom_placeholder' => esc_html__( 'bottom', 'matrik-core' ),
        'left_placeholder'   => esc_html__( 'left', 'matrik-core' ),
        'all_placeholder'    => esc_html__( 'all', 'matrik-core' ),
        'top'                => true,
        'left'               => true,
        'bottom'             => true,
        'right'              => true,
      ...
      $border_props = array(
        'solid'     => esc_html__( 'Solid', 'matrik-core' ),
        'dashed'    => esc_html__( 'Dashed', 'matrik-core' ),
        'dotted'    => esc_html__( 'Dotted', 'matrik-core' ),
        'double'    => esc_html__( 'Double', 'matrik-core' ),
        'inset'     => esc_html__( 'Inset', 'matrik-core' ),
        'outset'    => esc_html__( 'Outset', 'matrik-core' ),
        'groove'    => esc_html__( 'Groove', 'matrik-core' ),
        'ridge'     => esc_html__( 'ridge', 'matrik-core' ),
