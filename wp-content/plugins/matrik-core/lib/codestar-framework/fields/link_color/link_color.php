...
if ( ! class_exists( 'CSF_Field_link_color' ) ) {
  class CSF_Field_link_color extends CSF_Fields {
    ...
    public function render() {
      ...
      $color_props = array(
        'color'    => esc_html__( 'Normal', 'matrik-core' ),
        'hover'    => esc_html__( 'Hover', 'matrik-core' ),
        'active'   => esc_html__( 'Active', 'matrik-core' ),
        'visited'  => esc_html__( 'Visited', 'matrik-core' ),
        'focus'    => esc_html__( 'Focus', 'matrik-core' )
      );
