         ...
         <div class="nav-right">
             <?php if (class_exists('CSF')) : ?>
                 <div class="contact-area d-md-flex d-none">
                     <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_three_icon', 'url'))) : ?>
                         <div class="icon">
                             <img alt="image" src="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_three_icon', 'url')); ?>">
                         </div>
                     <?php endif; ?>
                     <div class="content">
                         <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_three_label'))) : ?>
                             <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_three_label')); ?></span>
                         <?php endif; ?>
                         <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_three_link', 'text'))) : ?>
                             <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_three_link', 'url')); ?>"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_three_link', 'text')); ?></a>
                         <?php endif; ?>
                     </div>
                 </div>
                 <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_btn_label'))) : ?>
                     <div class="right-sidebar-button">
                         ...
                         <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_three_btn_label')); ?></span>
                     </div>
                 <?php endif; ?>
             <?php endif; ?>
