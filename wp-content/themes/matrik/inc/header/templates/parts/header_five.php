...
<header class="header-area style-4">
    <div class="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
        ...
        <div class="menu-wrap">
            ...
            <div class="nav-right">
                <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_btn_label'))) : ?>
                    <div class="right-sidebar-button">
                        ...
                        <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_five_btn_label')); ?></span>
                    </div>
                <?php endif; ?>
...
<div class="right-sidebar-menu three">
