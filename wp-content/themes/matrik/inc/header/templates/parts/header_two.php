...
$page_header_mobile_logo = Egns\Helper\Egns_Helper::egns_page_option_value('page_header_sticky_logo', 'url');

$sticky_logo = Egns\Helper\Egns_Helper::egns_get_theme_option('header_sticky_logo', 'url');
$page_sticky_logo = Egns\Helper\Egns_Helper::egns_page_option_value('page_header_sticky_logo', 'url');
    ...
    <div class="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
        <div class="company-logo">
            <?php if (!empty($page_header_logo)) : ?>
                <a href="<?php echo esc_url(home_url('/')); ?>" class="logo-white"><img alt="image" class="img-fluid" src="<?php echo esc_url($page_header_logo); ?>"></a>
            <?php else : ?>
                <a href="<?php echo esc_url(home_url('/')); ?>" class="logo-white"><img alt="image" class="img-fluid" src="<?php echo esc_url($header_logo); ?>"></a>
            <?php endif; ?>

            <?php if (!empty($page_sticky_logo)) : ?>
                <a href="<?php echo esc_url(home_url('/')); ?>" class="logo-black"><img alt="image" class="img-fluid" src="<?php echo esc_url($page_sticky_logo); ?>"></a>
            <?php else : ?>
                <a href="<?php echo esc_url(home_url('/')); ?>" class="logo-black"><img alt="image" class="img-fluid" src="<?php echo esc_url($sticky_logo); ?>"></a>
            <?php endif; ?>
        </div>
        <div class="menu-wrap">
            <div class="main-menu">
                ...
                <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_two_btn_link', 'text'))) : ?>
                    <a class="primary-btn3 d-lg-none d-flex" href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_two_btn_link', 'url')); ?>">
                        <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_two_btn_link', 'text')); ?>
                        </span>
                        <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_two_btn_link', 'text')); ?>
                        </span>
            ...
            <div class="nav-right">
                <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_two_btn_link', 'text'))) : ?>
                    <a class="primary-btn3 d-lg-flex d-none" href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_two_btn_link', 'url')); ?>">
                        <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_two_btn_link', 'text')); ?>
                        </span>
                        <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_two_btn_link', 'text')); ?>
                        </span>
