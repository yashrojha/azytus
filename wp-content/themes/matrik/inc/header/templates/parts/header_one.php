...
<header class="header-area style-1 <?php echo !is_front_page() ? 'inner-page' : '' ?>">
    <div class="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
        ...
        <div class="main-menu">
            ...
            <div class="contact-area d-lg-none d-flex">
                <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_icon', 'url'))) : ?>
                    <div class="icon">
                        <img alt="image" src="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_icon', 'url')); ?>">
                    </div>
                <?php endif; ?>
                <div class="content">
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_label'))) : ?>
                        <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_label')); ?></span>
                    <?php endif; ?>
                    <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_link', 'text'))) : ?>
                        <a href="<?php echo esc_url(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_link', 'url')); ?>"><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_info_link', 'text')); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        <div class="nav-right">
            ...
            <?php if (!empty(Egns\Helper\Egns_Helper::egns_get_theme_option('header_btn_label'))) : ?>
                <div class="right-sidebar-button">
                    ...
                    <span><?php echo esc_html(Egns\Helper\Egns_Helper::egns_get_theme_option('header_btn_label')); ?></span>
                </div>
            <?php endif; ?>
