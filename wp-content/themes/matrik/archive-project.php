...
$posts_per_option = Egns\Helper\Egns_Helper::egns_get_theme_option('posts_per_page_option_project');
?>
<div class="project-grid-page sec-mar" id="scroll-section">
    <div class="container">
        ...
        <div class="row bounce_up">
            <div class="col-lg-12 d-flex justify-content-center">
                <div id="archive-load-more-project" class="load-more-for-project-btn mt-70">
